...
router.get('/blocked-emails', adminController.getBlockedEmails.bind(adminController));
router.delete('/blocked-emails/:email', adminController.unblockEmail.bind(adminController));
router.post('/blocked-names', adminController.blockName.bind(adminController));
router.get('/blocked-names', adminController.getBlockedNames.bind(adminController));
router.delete('/blocked-names/:id', adminController.unblockName.bind(adminController));
